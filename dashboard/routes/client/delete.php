...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $id = filter_var(cleanData($_POST['id_client']), FILTER_VALIDATE_INT, FILTER_SANITIZE_NUMBER_INT);
    if (!empty($id)) {
        $statement = $conexion->prepare('DELETE FROM client WHERE id_client = :id');
